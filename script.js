...
document.getElementById('calculate-h').addEventListener('click', function () {
    var a = parseFloat(document.getElementById('h-sideA').value);
    var b = parseFloat(document.getElementById('h-sideB').value);
    var c = parseFloat(document.getElementById('h-sideC').value);
    document.getElementById('h-result').value = heronsFormula(a, b, c);;
});
